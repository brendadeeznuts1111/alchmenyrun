        ...
        _jsxs("div", {
          ...
          children: [
            _jsx("h3", {
              ...
              children: "Workflow Started Successfully!",
            }),
            _jsxs("div", {
              className: "text-sm text-green-700",
              children: [
                _jsxs("div", {
                  children: ["Workflow ID: ", result.workflowId],
                }),
                _jsxs("div", {
                  className: "mt-2",
                  children: [
                    ...
                    _jsxs("ul", {
                      ...
                      children: [
                        _jsx("li", { children: "Validate user data" }),
                        _jsx("li", { children: "Create user profile" }),
                        _jsx("li", { children: "Send welcome email" }),
                        _jsx("li", { children: "Initialize user settings" }),
                      ],
                    }),
                  ],
                }),
