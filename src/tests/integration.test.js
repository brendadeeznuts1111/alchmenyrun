...
describe("Database Operations", () => {
    test("should create and retrieve users", async (scope) => {
        ...
        try {
            ...
            const testUserInList = data.users.find((user) => user.email === testEmail);
    ...
    test("should handle user validation errors", async (scope) => {
...
describe("File Operations", () => {
    test("should handle file upload and retrieval", async (scope) => {
...
describe("Cache Operations", () => {
    test("should set and get KV cache values", async (scope) => {
...
describe("Durable Object (Chat)", () => {
    test("should handle WebSocket upgrade and messaging", async (scope) => {
...
describe("Workflow Operations", () => {
    test("should trigger and execute workflows", async (scope) => {
...
describe("Error Handling", () => {
    test("should handle 404 for unknown endpoints", async (scope) => {
    ...
    test("should handle malformed JSON", async (scope) => {
...
async function assertWebsiteDoesNotExist(website) {
    try {
        const response = await fetch(`${website.url}/api/health`);
