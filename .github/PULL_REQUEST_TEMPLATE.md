...
<!-- Auto-generated by tgk CLI - DO NOT EDIT MANUALLY -->
**Files Changed:** `{{ changed_files_count || '0' }}` files
...
**Type:** `{{ pr_type || 'feat/fix/docs/refactor/test/chore' }}`
**Component:** `{{ component || 'queue/tunnel/worker/cli/telegram' }}`
**Department:** `{{ department || 'infrastructure/providers/quality/documentation' }}`
**Size:** `{{ size_label || 'size/s' }}` (auto-calculated)
